...
[view source](divergence-check-pro-ref-20150814.Rmd)
...
iicheck_rnaGTpro <- (ii_sig_rnapro) & ii_sig_Pro_DE & 
...
## c) ( abs(Protein FC) > abs(RNA FC) ) AND ( RNA FC * Protein FC < 0)
iicheck_proGTrna <- (ii_sig_rnapro) & ii_sig_Pro_DE & 
...
iicheck_null_proGTrna <- ii_sig_rnapro & !ii_sig_Pro_DE & ii_sig_RNA_DE
...
iicheck_null_proNULLrna <- ii_sig_rnapro & !ii_sig_RNA_DE & !ii_sig_Pro_DE
