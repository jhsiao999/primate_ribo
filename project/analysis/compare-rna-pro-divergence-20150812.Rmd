...
[view source](compare-rna-pro-divergence-20150812.Rmd)
...
1. ( abs(inter-species RNA FC) > abs(inter-species Protein FC) ) OR
   ( inter-species RNA FC and inter-species Protein FC are of 
     the opposite direction) - **Attenuation at the protein level**
       
2. ( abs(inter-species RNA FC) < abs(inter-species Protein FC) ) AND
